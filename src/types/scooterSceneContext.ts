...
export type TScooterSceneStateModifier = (state: IScooterSceneState) => Partial<IScooterSceneState>;

export type TScooterSceneSetState = (modifier: TScooterSceneStateModifier) => void;
